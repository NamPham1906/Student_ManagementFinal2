...
public class SEMESTER_ADD_UI extends JFrame {
    ...
    public SEMESTER_ADD_UI(JTable semesterTables){
        super("ADD NEW SEMESTER");
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (newSemesterID.equals("")){
                    ...
                    if (new SemesterDAO().addSemester(input)){
                        JOptionPane.showMessageDialog(SEMESTER_EDIT_UI, "Add Successfully!");
                    }else{
                        JOptionPane.showMessageDialog(SEMESTER_EDIT_UI, "Add failed!");
                    };
